...
EXPORT STD_Persons := MODULE
	...
	EXPORT File := TABLE($.UID_Persons,Layout):PERSIST('~CLASS::XYZ::PERSIST::STD_Persons');
	//EXPORT File := TABLE($.UID_Persons,Layout);
	// File:PERSIST('~CLASS::XYZ::PERSIST::STD_Persons');
END;
...
// EXPORT STD_Persons := MODULE
	...
	// EXPORT File := PROJECT($.UID_Persons,MyTransf(LEFT)):PERSIST('~CLASS::XYZ::PERSIST::STD_Persons-prj');
// END;