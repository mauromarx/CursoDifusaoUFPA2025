...
$.NormCrimeRecs.Layout Slimdown(RECORDOF($.Formatted_File) L, $.NormAddrRecs.Layout R) := TRANSFORM
...
OUTPUT(SlimRecs,,'~CLASS::XYZ::OUT::Crimes_Slim',OVERWRITE);
//OUTPUT(SlimRecs) : PERSIST('~CLASS::XYZ::OUT::Crimes_Slim');